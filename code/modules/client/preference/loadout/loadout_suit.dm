...
/datum/gear/suit/coat/job/med
	...
	allowed_roles = list("Medical Administrator", "Medical Doctor", "Chemist", "Psychiatrist", "Paramedic", "Virologist", "Brig Physician" , "Coroner")
...
/datum/gear/suit/labcoat_emt
	...
	allowed_roles = list("Medical Administrator", "Paramedic")
