...
/datum/game_mode/traitor
	...
	protected_jobs = list("Police Officer", "Warden", "Detective", "Sheriff", "Mayor", "Blueshield", "Nanotrasen Representative", "Security Pod Pilot", "Magistrate", "Lawyer", "Brig Physician", "Nanotrasen Navy Officer", "Special Operations Officer", "Syndicate Officer")
	required_players = 0
	required_enemies = 1
