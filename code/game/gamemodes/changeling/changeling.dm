...
/datum/game_mode/changeling
	...
	protected_jobs = list("Police Officer", "Warden", "Detective", "Sheriff", "Mayor", "Blueshield", "Nanotrasen Representative", "Security Pod Pilot", "Magistrate", "Brig Physician", "Lawyer", "Nanotrasen Navy Officer", "Special Operations Officer", "Syndicate Officer")
