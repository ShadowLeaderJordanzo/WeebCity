...
/obj/structure/closet/cardboard/attackby(obj/item/W as obj, mob/user as mob, params)
	if(src.opened)
		...
		if(istype(W, /obj/item/pen))
			var/decalselection = input("Please select a decal") as null|anything in list("Atmospherics", "Bartender", "Barber", "Blueshield",	"Brig Physician", "Mayor",
			"Cargo", "Chief Engineer",	"Chaplain",	"Chef", "Chemist", "Civilian", "Clown", "CMO", "Coroner", "Detective", "Engineering", "Genetics", "HOP",
			"HOS", "Hydroponics", "Lawyer", "Waste Collector",	"Magistrate", "Mechanic", "Medical", "Mime", "Mining", "NT Representative", "Paramedic", "Pod Pilot",
			"Prisoner",	"Research Director", "Security", "Syndicate", "Therapist", "Virology", "Warden", "Xenobiology") // come back to later
			if(!decalselection)
				return
